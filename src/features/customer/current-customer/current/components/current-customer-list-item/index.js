...
import PopupAction from '../../components/PopupmenuAction';
import styles from './styles';
const paddingVerticalHeader = 10;
const headerPaddingLeft = 10;

export default class CurrentCustomerListItem extends React.PureComponent {
	constructor(props) {
		super(props);
		this.state = {
			data: [],
	...
	_onViewDetail = element => {
		console.log('_onViewDetail', element);
	...
	render = () => {
		...
		return (
			<TouchableOpacity onPress={() => this._onViewDetail(item)}>
